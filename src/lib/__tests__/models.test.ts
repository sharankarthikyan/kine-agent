...
describe("listModels", () => {
  ...
  it("invokes list_models with the given agent id", async () => {
    ...
    const models: ModelInfo[] = [
      { value: "opus",   label: "Claude Opus 4.8",   agent: "claude", description: null, source: "fallback", disabled: false },
      { value: "sonnet", label: "Claude Sonnet 4.6", agent: "claude", description: null, source: "fallback", disabled: false },
      { value: "haiku",  label: "Claude Haiku 4.5",  agent: "claude", description: null, source: "fallback", disabled: false },
    ];
